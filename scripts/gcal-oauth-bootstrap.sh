#!/bin/bash
# One-shot wrapper around scripts/gcal-oauth-bootstrap.py.
#
...
# bootstraps a project-private virtualenv at ~/.openclaw-py (shared
# with the Gmail bootstrap), installs the two deps, and invokes the
# bootstrap script — one command instead of remembering the venv dance.
#
# Usage:
...
PY_SCRIPT="$SCRIPT_DIR/gcal-oauth-bootstrap.py"
